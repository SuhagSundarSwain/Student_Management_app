...
Seamless Communication: Developed RESTful APIs for seamless data communication, supporting HTTP methods such as GET, POST, PUT, and DELETE.
Multi-Platform: Created a web application using HTML, CSS, and JavaScript while developing a mobile app with Flutter, offering flexibility and accessibility to students.
Cloud and Docker: Leveraged cloud computing services for scalability and Docker for containerization, optimizing resource utilization.
